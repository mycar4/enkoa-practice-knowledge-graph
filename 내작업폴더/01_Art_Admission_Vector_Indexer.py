...
INDEX_TARGETS = [
    ...
    # 2026-09-22: 모집요강에는 "1단계: 2026-10-03(토)" 날짜만 있고 입실/고사
    # 시작 시각이 없다 - 대학이 전공별로 별도 발행하는 "수험생 유의사항" PDF에
    # 시각이 있음을 실측 확인(공간연출 1단계: 입실 08:30~09:00, 고사 시작 10:00).
    # 홍익대 미술활동보고서 작성안내와 같은 패턴으로 같은 university에 추가 색인.
    ("중앙대학교", "중앙대학교_2027학년도_공간연출1단계_수험생유의사항.pdf", 2027),
