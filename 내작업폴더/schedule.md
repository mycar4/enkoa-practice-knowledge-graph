...
> **🔒 DB 격리 정책**: 검수 완료된 DART 데이터 상태를 보존하기 위해, 향후 교육/실습용 Cypher 작업과 DART 프로젝트 DB는 완전 격리 운영을 원칙으로 합니다.
...
|:---:|---|:---:|:---:|---|
| **v0.2 Step 1** | **`DS001` 공시 인덱스 수집 및 DB 승격** | 1차 파일럿 100개사 | **🟢 합격** | • **[검수 스냅샷]** `:DART_Disclosure` `21,538건` / `[:FILED]` `21,538건`<br>• **[현재 파일럿 DB]** `:DART_Disclosure` `17,443건` / `[:FILED]` `17,443건`<br>• `01_DART_Disclosure_공시인덱스_수집기.py` |
