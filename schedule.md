...
| **v0.2 Step 3** | **Streamlit 대시보드 UI 연동 및 팩트 상세 패널 구축** | 프론트엔드 연동 | **🟢 합격 (검수 완료)** | • `app_dart_trace_dashboard.py` (우측 팩트 상세 패널 단일 상태 연동, 임의 번호 100% 제거, `UNLINKED` 표기, 후보 큐 상세 뷰, 5대 시나리오 실측 통과) |
